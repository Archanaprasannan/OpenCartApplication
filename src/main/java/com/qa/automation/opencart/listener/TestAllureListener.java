package com.qa.automation.opencart.listener;
...
//connecting the testng ITestListener to allure,so that we can listen to the testng events and capture the screenshots and logs in allure report. 
